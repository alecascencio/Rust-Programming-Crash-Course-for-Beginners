...
fn main() {
    ...
    // this is known as 'implicit' assignemt

    // x = "Alec" - you cannot do this as "Alec" is not an integer
    ...
    let (name, age, hobby) = ("Alec", 27, "drink coffee");
    println!("My name is {} and I am {}. I love to {}.", name, age, hobby);
